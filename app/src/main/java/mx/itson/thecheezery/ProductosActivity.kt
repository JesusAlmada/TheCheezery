...
class ProductosActivity : AppCompatActivity() {
   ...
   // var sweets = ArrayList<Product>()
    ...
    //var personalized = ArrayList<Product>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //var adaptador2 = AdaptadorProductos(this,sweets)
       // listview.adapter=adaptador2

//        var adaptador3 = AdaptadorProductos(this,salties)
  //      listview.adapter= adaptador3

    //    var adaptador4 = AdaptadorProductos(this,combos)
       // listview.adapter = adaptador4

       // var adaptador5 = AdaptadorProductos(this,personalized)
       // listview.adapter = adaptador5
    }
